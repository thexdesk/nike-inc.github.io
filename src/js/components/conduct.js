                ...
                [
                  ...
                  m("article.u-align-center.text-color-grey.pt4-sm.prl2-sm.prl12-md.pb6-sm",
                    [
                      ...
                      m("a.ncss-btn.border-light-grey.text-color-grey.ncss-brand.pt2-sm.pr5-sm.pb2-sm.pl5-sm.mt6-sm[href='https://github.com/Nike-Inc/nike-inc.github.io/blob/master/CONDUCT.md']", 
                        "VIEW"
                      )
                    ]
                  )
